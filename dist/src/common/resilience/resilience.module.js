...
exports.ResilienceModule = ResilienceModule = __decorate([
    (0, common_1.Module)({
        providers: [resilience_service_1.ResilienceService, lru_cache_service_1.LRUCacheService],
        exports: [resilience_service_1.ResilienceService, lru_cache_service_1.LRUCacheService],
    })
], ResilienceModule);
